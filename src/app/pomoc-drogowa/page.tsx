...
export const metadata: Metadata = {
  ...
  description: `Pomoc Drogowa, Laweta i Holowanie ☎️ 572 272 930. LAWECIARZ.PRO to profesjonalna pomoc drogowa 24h w całej Polsce. Oferujemy holowanie, lawetę i serwis. Dojazd in 15 minut!`,
  alternates: {
